...
| 30 | Portal rendering: draw native-visible type-2 portals (`MapHelper.img/portal/game/pv`) at parsed portal coordinates, keep spawn/invisible portals hidden, and preserve live map-to-map travel via non-migrate `SetField`; hidden/script portal reveal states remain deferred | shipped |
